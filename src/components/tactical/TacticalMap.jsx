...
export default function TacticalMap({ selectedVehicle }) {
  ...
  useEffect(() => {
    ...
    L.tileLayer('https://basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png?key=cb1_3i2e_1_a218eeefb382e978423d8c13', { attribution: '&copy; OpenStreetMap contributors &copy; CARTO', maxZoom: 19 }).addTo(map);
